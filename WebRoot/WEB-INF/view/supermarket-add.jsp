...
<html>
  ...
  <div style="margin:0 auto; position:relative; width:600px;">
     <s:form action="supermarket-add.action" method="post">
    	<s:textfield name="supermarket.superName" label="类别名称"></s:textfield> 
    	<s:textfield name="supermarket.superPrice" label="类别单价"></s:textfield> 
